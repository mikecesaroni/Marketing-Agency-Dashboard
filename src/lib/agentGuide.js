...
export const ROUTES = [
  ...
  },
  {
    ...
    actions: [
      ...
      '"Pause client" next to it puts a client on pause: still a client everywhere (lists, MRR, sync), but the dashboard\'s ads-stopped alert and the Content board\'s "10+ days without a new ad" flag leave them alone until "Resume client". An amber banner at the top of the page says they are paused.',
